...
public class FixmReflectDataTest {

  /**
   * Test of createSchema method, of class FixmReflectData.
   */
  @Test
  public void testCreateSchema() {
    FixmAvroConverter.<MessageCollectionType>getAvroSerializer().getSchema();
  }
}
